...
namespace AmazonMWSTester.Amazon {
    ...
    public partial class ProcessingReport {
        ...
        private List<ProcessingReportResult> resultField;
        
    [System.Xml.Serialization.XmlElementAttribute(DataType="positiveInteger")]
    public string DocumentTransactionID {get; set;}

    public ProcessingReportStatusCode StatusCode {get; set;}

    public ProcessingReportProcessingSummary ProcessingSummary {get; set;}

        
        public ProcessingReport() {
            this.resultField = new List<ProcessingReportResult>();
            this.processingSummaryField = new ProcessingReportProcessingSummary();
        }
        
        [System.Xml.Serialization.XmlElementAttribute("Result")]
        public List<ProcessingReportResult> Result {
            get {
