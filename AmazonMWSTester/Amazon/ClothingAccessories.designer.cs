...
namespace AmazonMWSTester.Amazon {
    ...
    public ClothingAccessoriesVariationData VariationData {get; set;}

    public ClothingAccessoriesClassificationData ClassificationData {get; set;}

        
        public ClothingAccessories() {
            this.classificationDataField = new ClothingAccessoriesClassificationData();
            this.variationDataField = new ClothingAccessoriesVariationData();
        }
    }
}
