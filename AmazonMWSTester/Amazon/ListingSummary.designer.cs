...
namespace AmazonMWSTester.Amazon {
    ...
    public partial class ListingSummary {
        ...
        private string pendingQuantityField;
        
        private ListingSummaryShipping shippingField;
        
    [System.Xml.Serialization.XmlElementAttribute(DataType="normalizedString")]
    public string SKU {get; set;}

    public ListingReportType ReportType {get; set;}
    ...
    public ListingSummaryShipping Shipping {get; set;}

        
        public ListingSummary() {
            this.shippingField = new ListingSummaryShipping();
        }
    }
}
